import {
  setupHMR
} from "./chunk-ppjthysg.js";
import {
  client_routes_default
} from "./chunk-04zdwj09.js";
import {
...
function getRelatedLayoutFromPathname(pathname, routes) {
  ...
  const layouts = Object.assign({}, ...Object.entries(routes).filter(([pathname2, _layout]) => pathname2.endsWith("layout")).map(([k, v]) => ({ [k]: v })));
...
function WrapWithLayouts({
  ...
  return layouts.reduceRight((acc, Layout, _i) => {
    return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(Layout, {
      children: acc
    }, Layout.toString(), false, undefined, this);
  }, children);
}
...
// ../src/router.tsx
var jsx_dev_runtime2 = __toESM(require_jsx_dev_runtime2(), 1);
function RouterHost({ children }) {
  const [CurrentPage, setCurrentPage] = import_react.useState(() => children);
  const [routes, setRoutes] = import_react.useState(typeof window === "undefined" ? {} : client_routes_default);
  const createPage = import_react.useCallback((_pathname, routes2) => {
    const pathname = formatPathname(_pathname);
    const layouts = getRelatedLayoutFromPathname(pathname, routes2);
    const Page = routes2[pathname];
    if (!Page)
      return () => /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
        children: "404 - Page Not Found"
      }, undefined, false, undefined, this);
    return () => /* @__PURE__ */ jsx_dev_runtime2.jsxDEV(WrapWithLayouts, {
      layouts,
      children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV(Page, {}, undefined, false, undefined, this)
    }, undefined, false, undefined, this);
  }, []);
  import_react.useEffect(() => globalThis.HMR_ENABLED ? setupHMR((newRoutes) => {
    setRoutes(newRoutes);
    setCurrentPage(createPage(window.location.pathname, newRoutes));
  }) : undefined, [createPage]);
...
function ClientShell({
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(RouterHost, {
    children
  }, undefined, false, undefined, this);
}
export { require_react, require_jsx_dev_runtime2 as require_jsx_dev_runtime, getRelatedLayoutFromPathname, formatPathname, ClientShell };

//# debugId=E323ECC86D18816364756E2164756E21
//# sourceMappingURL=./chunk-8z58j1qm.js.map
